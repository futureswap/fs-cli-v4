...
const DEFAULT_LIQUIDATION_BOT_API: {
  ...
  RINKEBY_ARBITRUM: {
    v4: "0x3952BAb3a21a4Fd61f1EaeF3E6a63c6f50Aae1D4",
...
const getLiquidationBotV4Args = <T = {}>(
  ...
  const exchangeLaunchBlock = getNumberArg(
    ...
    argv,
    {
      default: DEFAULT_EXCHANGE_LAUNCH_BLOCK[network]["v4"][exchangeAddress],
      isInt: true,
      isPositive: true,
    }
  );
...
const getLiquidationBotV4_1Args = <T = {}>(
  ...
  const exchangeLaunchBlock = getNumberArg(
    ...
    {
      default:
        DEFAULT_EXCHANGE_LAUNCH_BLOCK[network]["v4_1"][tradeRouterAddress],
      isInt: true,
      isPositive: true,
    }
  );
